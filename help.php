...
<head>
    ...
    <title>Help Center - Fresh-Factor</title>
...
<body class="bg-[#F9FBE7]">
    ...
    <div class="container mx-auto px-6 py-20">
        <h1 class="text-4xl font-bold text-[#1B5E20] mb-12 text-center"><?php echo htmlspecialchars(t('help_center_title')); ?></h1>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white p-8 rounded-2xl shadow-sm text-center">
                <i class="fas fa-truck text-4xl text-[#43A047] mb-4"></i>
                <h3 class="font-bold text-xl mb-2"><?php echo htmlspecialchars(t('delivery_info')); ?></h3>
                <p class="text-gray-500 text-sm"><?php echo htmlspecialchars(t('delivery_info_desc')); ?></p>
            </div>
            <div class="bg-white p-8 rounded-2xl shadow-sm text-center">
                <ul>
            ...
            <div class="bg-white p-8 rounded-2xl shadow-sm text-center">
                <i class="fas fa-question-circle text-4xl text-[#43A047] mb-4"></i>
                <h3 class="font-bold text-xl mb-2"><?php echo htmlspecialchars(t('faqs')); ?></h3>
                <p class="text-gray-500 text-sm"><?php echo htmlspecialchars(t('faqs_desc')); ?></p>
            </div>
        </div>
    </div>
